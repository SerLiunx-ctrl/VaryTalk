...
import com.serliunx.varytalk.security.support.ValidationChainBuilder;
...
public class ApiValidationProcessor implements ApplicationContextAware {
    ...
    @Before("@annotation(com.serliunx.varytalk.security.annotation.ApiValidation)")
    public void process(JoinPoint joinPoint){
        ApiValidation apiValidation = getApiValidation(joinPoint);
        if(isChain(apiValidation)){
    ...
    private void processSingle(JoinPoint joinPoint){
        ...
        boolean b = validator.preValidate(buildContext(joinPoint));
        if(!b){
    ...
    private void processChain(JoinPoint joinPoint){
        ...
        ApiValidation apiValidation = getApiValidation(joinPoint);
        ValidationContext context = buildContext(joinPoint);
