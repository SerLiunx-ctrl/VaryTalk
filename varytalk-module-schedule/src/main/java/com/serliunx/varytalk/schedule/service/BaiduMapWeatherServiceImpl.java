 ...
 */
@Service
public class BaiduMapWeatherServiceImpl implements BaiduMapWeatherService{
    ...
    public BaiduMapWeatherServiceImpl(BaiduMapWeatherClient baiduMapWeatherClient) {
